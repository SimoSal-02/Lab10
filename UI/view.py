...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        #row2
        self._ddStato=ft.Dropdown(label="Stato",options=[], disabled=True,width=200)
        self._btnCalcolaRaggiungibili = ft.ElevatedButton(text="Calcola Raggiungibili",on_click=self._controller.handleRaggiungibili,disabled=True, width=200)
        row2 = ft.Row([self._ddStato,self._btnCalcolaRaggiungibili],alignment=ft.MainAxisAlignment.CENTER)
